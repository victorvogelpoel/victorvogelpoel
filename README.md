...
- I work for Team Rockstars IT as a .NET software engineer and solution architect. I worked on an case management solution for Dutch Enforcement and networking capacity solution for a large Dutch telecoms provider.
- Priory, I was a technical consultant, building integration solutions for customers with .NET, PowerShell and M-Files Intelligent Document Management, doing very large document migrations and managing a letter generator for several health insurance citizen regulations at semi-government company Het CAK.
...
- Learning more about application solution architecture and other design patterns.
...
### RECENT
- Working on a Events Calendar for Team Rockstars, showing upcoming events in their Outlook agenda, week web calendar and WebAPI.

### NOT SO RECENT ANYMORE
